...
export function href(_lang: Lang, area = '', slug = '') { if(slug&&area==='projects')return '/works/'+slug+'/';if(slug&&area==='works')return '/cases/'+slug+'/';const base = area === 'projects' ? 'works' : area; return '/' + (base ? base + '/' : ''); }
